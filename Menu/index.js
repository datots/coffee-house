...
cards.forEach((item) => {
  item.addEventListener("click", (e) => {
    ...
    document.getElementById("size").innerHTML = serverData[id].sizes;
    document.getElementById("additive").innerHTML = serverData[id].additives;
  });
});
